...
from ...common.residue_constants import restype_atom14_to_rigid_group, restype_atom14_rigid_group_positions, restype_atom14_mask, restype_rigid_group_default_frame
from ...common.utils import generate_new_affine, to_tensor, from_tensor, vecs_to_tensor, atom14_to_atom37, \
...
class MultiRigidSidechain(nn.Cell):
    ...
    def __init__(self, config, global_config, single_repr_dim):
        ...
        self.restype_atom14_to_rigid_group = Tensor(restype_atom14_to_rigid_group)
        self.restype_atom14_rigid_group_positions = Tensor(restype_atom14_rigid_group_positions)
        self.restype_atom14_mask = Tensor(restype_atom14_mask)
        self.restype_rigid_group_default_frame = Tensor(restype_rigid_group_default_frame)
