...
class Constraint(Controller):
    ...
    def construct(self,
        ...
        """ Use a constraint in given system.
        Args:
            coordinate: The new coordinates after 1-step evolution.
            velocity: The new velocity at new position.
            force: The new force at new position.
            energy: The corresponding energy at new position.
            kinetics: The new system kinetics.
            virial: The new virial at new position.
            pbc_box: The periodic box size.
            step: Step counter.

        Returns:
            All Args after constraint.
        """
